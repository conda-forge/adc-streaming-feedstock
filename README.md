...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/adc-streaming-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14070&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/adc-streaming-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `adc-streaming` can be installed with:

```
conda install adc-streaming
```

It is possible to list all of the versions of `adc-streaming` available on your platform with:
